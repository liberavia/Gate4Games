...
[{if $oView->showSearch() }]
    ...
    <form class="search" action="[{ $oViewConf->getSelfActionLink() }]" method="get" name="search">
        <div class="searchBox">
            ...
            <label for="searchParam" class="innerLabel">[{oxmultilang ident="LV_SEARCH_IN_CURRENTLY"}] <span class="G4GCiColor">[{$oViewConf->lvGetAmountArticles()}]</span> [{oxmultilang ident="LV_GAME_TITLES"}]...</label>
