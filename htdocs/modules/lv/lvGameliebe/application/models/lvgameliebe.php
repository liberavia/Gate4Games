...
/**
 * Description of lvgameliebe
 *
 * @author Gate4Games
 * @author André Gregor-Herrmann
 */
class lvgameliebe extends oxBase {
    ...
    public function __construct() {
        ...
        $this->_iLogLevel           = (int)$this->_oLvConf->getConfigParam( 'sLvGlLogLevel' );
    ...
    protected function _lvParseRequest( $aResponse, $sLangAbbr ) {
        ...
        foreach ( $aResponse as $aArticle ) {
            $sId                                        = (string)$aArticle[6];
            $dPrice                                     = (double)str_replace( ",", ".", $aArticle[2] );
            $sTitle                                     = trim( $aArticle[0]." ".$aArticle[1] );
            ...
            $aArticleData[$sId]['COVERIMAGE']           = trim( $aArticle[8] );
