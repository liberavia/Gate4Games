...
$aModule = array(
    ...
    'extend'       => array(
        ...
        // models
        'lvyoutube'                        => 'lv/lvYouTubeAddonLetsPlay/extend/application/models/lvyoutube_letsplay.php',
    ),
    'files' => array(
    ),
    'events'       => array(
    ...
    'settings' => array(
        ...
        array( 'group' => 'lvyoutubeparams',        'name' => 'sLvApiChannelIdLep',                 'type' => 'str',        'value' => '' ),
    )
);
