...
<html>
<head>
<title>[{oxmultilang ident="LV_EMAIL_PRICEALARM_CUSTOMER_PRICEALARMIN"}][{$shop->oxshops__oxname->value}]</title>
...
[{oxmultilang ident="LV_EMAIL_PRICEALARM_CUSTOMER_ITEM3"}] <strong>[{$oPriceAlarm->getFPrice()}] [{$currency->sign}]</strong>  [{oxmultilang ident="LV_EMAIL_PRICEALARM_CUSTOMER_ITEM4"}]<br>
<br>
