...
[{if $oView->lvGetTopSale()}]
    [{include file="widget/product/list.tpl" type=$oViewConf->getViewThemeParam('sStartPageListDisplayType') head="LV_TOP_SELLER"|oxmultilangassign listId="lvTopSeller" products=$oView->lvGetTopSale()  showMainLink=true}]
[{/if}]
